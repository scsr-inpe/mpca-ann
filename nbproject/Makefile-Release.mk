...
${OBJECTDIR}/src/annActivation.o: src/annActivation.f90 
	...
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/annActivation.o src/annActivation.f90
...
${OBJECTDIR}/src/annTraining.o: src/annTraining.f90 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/annTraining.o src/annTraining.f90

${OBJECTDIR}/src/foul.o: src/foul.f90 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/foul.o src/foul.f90

${OBJECTDIR}/src/main_activation.o: src/main_activation.f90 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/main_activation.o src/main_activation.f90
