...
${OBJECTDIR}/src/main_generalization.o: src/main_generalization.f90 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -o ${OBJECTDIR}/src/main_generalization.o src/main_generalization.f90

${OBJECTDIR}/src/mpca.o: src/mpca.f90 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -o ${OBJECTDIR}/src/mpca.o src/mpca.f90

${OBJECTDIR}/src/mpcaFunctions.o: src/mpcaFunctions.f90 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -o ${OBJECTDIR}/src/mpcaFunctions.o src/mpcaFunctions.f90

${OBJECTDIR}/src/newTypes.o: src/newTypes.f90 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -o ${OBJECTDIR}/src/newTypes.o src/newTypes.f90

${OBJECTDIR}/src/normalR8.o: src/normalR8.f90 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -o ${OBJECTDIR}/src/normalR8.o src/normalR8.f90

${OBJECTDIR}/src/uniformR8.o: src/uniformR8.f90 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -o ${OBJECTDIR}/src/uniformR8.o src/uniformR8.f90
